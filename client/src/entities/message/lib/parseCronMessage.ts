...
/**
 * Detect the scheduled-task header format that OpenClaw injects when a cron
 * job fires a message to the agent, and split it into renderable parts.
 * Returns null if the message is a regular user message.
 */
